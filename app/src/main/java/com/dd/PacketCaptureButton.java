...
public class PacketCaptureButton extends Button {
    ...
    private PacketCaptureButtonStateManager mStateManager;
    ...
    public PacketCaptureButton(Context context) {
        super(context);
        init(context, null);
    }

    public PacketCaptureButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public PacketCaptureButton(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mMaxProgress = 100;
        mState = State.IDLE;
        mStateManager = new PacketCaptureButtonStateManager(this);
    ...
    private void morphCompleteToError() {
        MorphingAnimation animation = createMorphing();
        animation.setFromColor(getNormalColor(mCompleteColorState));
    ...
    private void morphErrorToProgress() {
        setWidth(getWidth());
        setText(mProgressText);
        MorphingAnimation animation = createProgressMorphing(mCornerRadius, getHeight(), getWidth(), getHeight());
        animation.setFromColor(getNormalColor(mErrorColorState));
